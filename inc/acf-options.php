...
if (function_exists('acf_add_options_page')) {
    ...
    acf_add_options_page(array(
        'page_title'    => __('Clinic Settings', 'dental-care'),
        'menu_title'    => __('Clinic Settings', 'dental-care'),
    ...
    acf_add_local_field_group(array(
        ...
        'title'         => __('Clinic Settings', 'dental-care'),
        'fields'        => array(
            array(
                'key'           => 'field_mlt_clinic_logo',
                'label'         => __('Clinic Logo', 'dental-care'),
            ...
            array(
                ...
                'label'         => __('Clinic Tagline', 'dental-care'),
            ...
            array(
                ...
                'label'         => __('About the Clinic', 'dental-care'),
                'name'          => 'mlt_about_text',
                'type'          => 'wysiwyg',
                'tabs'          => 'all',
                'toolbar'       => 'full',
            ...
            array(
                ...
                'label'         => __('Alternative Email', 'dental-care'),
                'name'          => 'mlt_clinic_email_alt',
                'type'          => 'email',
            ),
            array(
                'key'           => 'field_mlt_clinic_phone_alt',
                'label'         => __('Alternative Phone', 'dental-care'),
